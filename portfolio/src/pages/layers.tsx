            ...
            rows.push(
                <div key={i} className="row  z-50 relative flex py-6 overflow-x-clip w-full justify-center  gap-4">
                    <div className="card relative left-card ov w-[500px]">
                        <img src={`./img-l-${2 * i - 1}.png`} className="rounded-2xl" style={{ transformOrigin: "center" }} />
                    </div>
                    <div className="card relative right-card w-[500px]">
                        <img src={`./img-l-${2 * i}.png`} className="rounded-2xl" style={{ transformOrigin: "center" }} />
                    </div>
                </div>
            );
        }
    ...
    return (
        ...
        <Back/>
         <div className="w-full pt-24 px-8">
                   <ReactLenis root>
                       <div className="flex pt-24 flex-col gap-10">
                           ...
                           transition={{
                             ...
                             duration: 1.2}} 
                           className="font-secondary scale-y-130 font-medium text-5xl">Layers</motion.div>
                           <motion.div
                              initial={{ y: 20, opacity: 0 }}
                              animate={{ y: 0, opacity: 1 }}
                              transition={{
                           ...
                           LayersWebsite is a fully frontend application built with React, TypeScript, and Framer Motion. It features smooth animations and dynamic layering effects for an engaging user experience.
                           </motion.div>
                           <motion.div 
                              initial={{ y: 20, opacity: 0 }}
                              animate={{ y: 0, opacity: 1 }}
                         ...
                         <button className="bg-black shadow-2xl shadow-black hover:shadow-[0px_-5px_10px_rgba(255,255,255,0.2)] hover:shadow-black/40 font-semibold cursor-pointer text-white lg:w-28 w-full h-11 text-md rounded-3xl">
                             ...
                             <a href="https://github.com/Piyush631/Layers" target="_blank"> 
            ...
            <div className="lg:text-4xl md:text-2xl text-xl font-secondary lg:pt-12 md:pt-8 pt-4 scale-y-120  text-center"><span className="text-black ">Layers</span> </div>
            ...
            <div className=" flex flex-wrap  lg:gap-3 gap-2 w-full lg:w-1/2 justify-center ">
              ...
              <button className="bg-black z-50 text-white cursor-pointer text-xs lg:text-md   px-2 py-1 rounded-2xl hover:bg-white hover:text-black">Framer Motion</button>
              <button className="bg-black z-50 text-white cursor-pointer text-xs lg:text-md   px-2 py-1 rounded-2xl hover:bg-white hover:text-black">Tailwind CSS</button>
