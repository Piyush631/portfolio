...
export default function ChatPage() {
            ...
            rows.push(
                <div key={i} className="row z-50 relative flex py-6 overflow-x-clip w-full justify-center  gap-4">
                    <div className="card relative left-card ov w-[500px]">
                        <img src={`./img-c-${2 * i - 1}.png`} className="rounded-2xl" style={{ transformOrigin: "center" }} />
                    </div>
                    <div className="card relative right-card w-[500px]">
                        <img src={`./img-c-${2 * i}.png`} className="rounded-2xl" style={{ transformOrigin: "center" }} />
                    </div>
                </div>
            );
        }
        ...
        <div className="w-full pt-24 px-8">
                               <ReactLenis root>
                                   <div className="flex pt-24 flex-col gap-10">
                                       ...
                                       className="font-secondary scale-y-130 font-medium text-5xl">ChatSphere</motion.div>
                                       <motion.div
                                          initial={{ y: 20, opacity: 0 }}
                                          animate={{ y: 0, opacity: 1 }}
                                          transition={{
                                       ...
                                       Developed a real-time chat application using React, TypeScript, and WebRTC for seamless communication. Implemented a modern glass effect UI for an enhanced user experience.
                                       </motion.div>
                                       <motion.div
                                          initial={{ y: 20, opacity: 0 }}
                                          animate={{ y: 0, opacity: 1 }}
                                      ...
                                      <a href="https://piyush-chatsphere.netlify.app/" target="_blank">
                                     ...
                                     <a href="https://github.com/Piyush631/chatsphere" target="_blank">       <button className="text-black border border-black/60 cursor-pointer font-semibold lg:w-28 hover:border-black h-11 text-md rounded-3xl w-full">
                                               Git Hub
                                           </button> </a>
                                       </motion.div>
                                   </div>
    ...
    <div className="lg:text-4xl md:text-2xl text-xl font-secondary lg:pt-12 md:pt-8 pt-4 scale-y-120  text-center"><span className="text-black ">ChatSphere</span> </div>
    <div className="w-full  lg:pt-10 pt-7 flex justify-center">
    <div className=" flex flex-wrap  gap-3 lg:w-1/2 w-full justify-center ">
      <button className="bg-black z-50 text-xs lg:text-md  text-white cursor-pointer   px-2 py-1 rounded-2xl hover:bg-white hover:text-black">React js</button>
      <button className="bg-black z-50 text-xs lg:text-md  text-white cursor-pointer   px-2 py-1 rounded-2xl hover:bg-white hover:text-black">TypeScript</button>
      <button className="bg-black z-50 text-xs lg:text-md  text-white cursor-pointer   px-2 py-1 rounded-2xl hover:bg-white hover:text-black">WebRtc</button>
      <button className="bg-black z-50 text-xs lg:text-md  text-white cursor-pointer   px-2 py-1 rounded-2xl hover:bg-white hover:text-black">Tailwind CSS</button>
      <button className="bg-black z-50 text-xs lg:text-md  text-white cursor-pointer   px-2 py-1 rounded-2xl hover:bg-white hover:text-black">Express</button>
    </div>
    </div>
